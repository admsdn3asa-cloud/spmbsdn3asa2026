...
const DEFAULT_FORM_FIELDS = [
  ...
  { id: "Agama", label: "Agama", type: "select", options: ["Islam", "Kristen","Katolik","Hindu","Budha"], required: true },
  { id: "Alamat", label: "Alamat Lengkap", type: "textarea", required: true },
  { id: "Nama Dusun/Lingkungan", label: "Nama Dusun/Lingkungan", type: "text", required: true},
  ...
  { id: "Tempat Tinggal", label: "Tempat Tinggal", type: "select", options: ["Bersama Orang Tua", "Bersama Saudara/Wali"], required: true},
  { id: "Transportasi Ke Sekolah", label: "Transportasi Ke Sekolah", type: "select", options: ["Jalan kaki","Motor","Sepeda"], required: true},
  { id: "No HP Orang Tua/Wali", label: "No HP Orang Tua/Wali", type: "text", required: true},
  { id: "Nama Ayah Kandung", label: "Nama Ayah Kandung", type: "text", required: true },
  { id: "Tahun Lahir Ayah", label: "Tahun Lahir Ayah", type: "text", required: true},
  { id: "Pendidikan Terakhir Ayah", label: "Pendidikan Terakhir Ayah", type: "text", required: true},
  { id: "Pekerjaan Ayah", label: "Pekerjaan Ayah", type: "text", required: true},
  { id: "Penghasilan Ayah PerBulan", label: "Penghasilan Ayah PerBulan", typr: "select", options: ["Rp. 500.000 - Rp. 1.000.000","Rp. 1.500.000 - Rp. 2.000.000", "Rp. 2.500.000 - Rp. 5.000.000"], required: true},
  { id: "Nama Ibu Kandung", label: "Nama Ibu Kandung", type: "text", required: true },
  { id: "Tahun Lahir Ibu", label: "Tahun Lahir Ibu", type: "text", required: true},
  { id: "Pendidikan Terakhir Ibu", label: "Pendidikan Terakhir Ibu", type: "text", required: true},
  { id: "Pekerjaan Ibu", label: "Pekerjaan Ibu", type: "text", required: true},
  { id: "Penghasilan Ibu PerBulan", label: "Penghasilan Ibu PerBulan", typr: "select", options: ["Rp. 500.000 - Rp. 1.000.000","Rp. 1.500.000 - Rp. 2.000.000", "Rp. 2.500.000 - Rp. 5.000.000"], required: true},
...
const DEFAULT_SETTINGS = {
  namaSekolah: "SDN 3 AIR SALEK",
  alamat: "Jalur 6 Jembatan 2 Desa Saleh Jaya",
  telepon: "085 211 9002 38",
  email: "info@sdn3asa.sch.id",
